...
PADDLE_ONE_STARTING_POSITIONS_LIST = [(-300, -20), (-300, -15), (-300, -10), (-300, -5),(-300, 0), (-300, 5), (-300, 10),(-300, 15), (-300, 20)]

PADDLE_TWO_STARTING_POSITIONS_LIST = [(300, -20), (300, -15), (300, -10), (300, -5),(300, 0), (300, 5), (300, 10),(300, 15), (300, 20)]
...
class Paddles():
    ...
    def move_paddle_one_turn_on_toggle_or_wall(self):
        """Moves the paddle, changing direction on toggle or collission with wall"""
    ...
    def toggle_paddle_one(self):
        ...
        if self.paddle_one_list[0].heading() == 90:
            for segment in range(0, len(self.paddle_one_list)):
                self.paddle_one_list[segment].setheading(270)
        elif self.paddle_one_list[0].heading == 270:
